				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Know Yourself</span>
							<h1>BETTER</h1>
						</div>
					</div>
				</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2>GET STARTED</h2>
					<p>Get ready to now about your profile and improvement in your health on the basis of your regular check-ups.</p>
				</div>
			</div>
            ...
            <div class="container-fluid" style="padding-top: 2rem; padding-bottom: 4rem; ">
                <div class="row my-3 row_margin">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 my-2">
                        ...
                        <div onclick="location.href='profile.php'" class="card img-fluid" style="color: white; cursor: pointer;">
                            <div class="hello">
                            ...
                            <div class="card-img-overlay">
                                <div class="overlay1 text-center">
                                    ...
                                    <div class="author-name">PROFILE</div>
                                    <h4>About you!</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 my-2">
                        ...
                        <div onclick="location.href='charts.php'" class="card img-fluid" style="color: white; cursor: pointer;">
                            ...
                            <div class="card-img-overlay">
                                <div class="overlay1 text-center">
                                    <img src="images/logo2.png" id="author-img">
                                    <div class="author-name">CHARTS</div>
                                    <h4>Important growth and nutrition charts related to you!</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 my-2">
                        ...
                        <div onclick="location.href='#'" class="card img-fluid" style="color: white; cursor: pointer;">
                            <div class="hello">
                                <img class="card-img-top hello" id="my-image" src="images/img_5.jpg" alt="Card image" style="width:100% height: 100%;">
                                <div class="black-masking"></div>
                            </div>
                            ...
                            <div class="card-img-overlay">
                                <div class="overlay1 text-center">
                                    <img src="images/logo3.png" id="author-img">
                                    <div class="author-name">SCHEDULE MAINTENANCE</div>
                                    <h4>Let's see what is next check-up waiting for you!</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div onclick="location.href='#'" class="card img-fluid" style="color: white; cursor: pointer;">
                            ...
                            <div class="card-img-overlay">
                                <div class="overlay1 text-center">
                                    ...
                                    <div class="author-name">SPECIAL RECOMMENDATION</div>
                                    <h4>(If any)</h4>
                                </div>
                            </div>
                        </div>
